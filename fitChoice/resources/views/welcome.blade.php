...
@section('content')
    ...
    <div class="flex flex-wrap justify-center gap-8 py-12">       
            @include('layouts.card', [
                ...
                'primaryButtonText' => 'Pay Now - $99.99/month',
                'primaryButtonUrl' => '/payment/elite'
            ])
            ...
            @include('layouts.card', [
                ...
                'primaryButtonText' => 'Pay Now - $79.99/month',
                'primaryButtonUrl' => '/payment/pro'
            ])
            ...
            @include('layouts.card', [
                ...
                'primaryButtonText' => 'Pay Now - $49.99/month',
                'primaryButtonUrl' => '/payment/select'
            ])
        </div>
@endsection
